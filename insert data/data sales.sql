...
VALUES (1, '2022-06-22', '2022-06-30',  '2022-06-28', 'ORD#20220727-0000001', 131899555,100000, 0, 50000, 'Closed');

INSERT INTO sales.sales_order_detail (sode_id, sode_qty, sode_unit_price, sode_unit_discount,sode_line_total,sode_modified_date,sode_sohe_id,sode_prog_entity_id)
...
VALUES (1, 'Dapatkan discount 50%, untuk 5 orang', 50, '2022-7-27', '2022-10-27', 1, 5, 1);

INSERT INTO sales.special_offer_programs (soco_spof_id, soco_prof_entity_id )
VALUES (1, 1),(1, 3);
