...
create table users.users_skill(
    ...
    foreign key (uski_skty_name) references master.skil_type(skty_name)
)
...
create table curriculum.progam_reviews(
    ...
    constraint prow_pk primary key (prow_user_entity_id, prow_prog_entity_id),
